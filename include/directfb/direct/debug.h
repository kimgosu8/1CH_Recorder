...
#define D_DEBUG_DOMAIN(identifier,name,description)                                  \
	static DirectDebugDomain identifier __attribute__((unused)) = { 0, false, false, name, description, sizeof(name) - 1 }

void direct_debug_at_always( DirectDebugDomain *domain, const char *format, ... )  D_FORMAT_PRINTF(2);
...
void direct_debug_at( DirectDebugDomain *domain,  const char *format, ... )  D_FORMAT_PRINTF(2);
void direct_debug_enter( DirectDebugDomain *domain, const char *func, const char *file,  int line, const char *format, ... )  D_FORMAT_PRINTF(5);
void direct_debug_exit( DirectDebugDomain *domain, const char *func, const char *file, int line, const char *format, ... )  D_FORMAT_PRINTF(5);
void direct_break( const char *func, const char *file, int line, const char *format, ... )  D_FORMAT_PRINTF(4);
void direct_assertion( const char *exp, const char *func, const char *file, int line );
void direct_assumption( const char *exp, const char *func, const char *file, int line );
#endif
